...
public class Messages {
    public static final String WIN_GAME="Congratulations, you are the winner of this game";
    ...
    public static final String ERROR_TYPE_INVALID_NUMBERS_OF_CARD="Invalid Numbers of Card";
    public static final String ERROR_TYPE_INVALID_SUITS_TYPE="Invalid Suits Type";
    public static final String ERROR_TYPE_FAIL_TO_DELETE_CARD="Failed to delete or find the intended card";
